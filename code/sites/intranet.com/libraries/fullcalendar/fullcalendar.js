...
DayGrid.mixin({
	...
	renderSegRow: function(row, rowSegs) {
		...
		for (i = 0; i < levelCnt; i++) { // iterate through all levels
          ...
          // to hanlde indivisual events from same date
          var event_date=seg.event.start['_i'].replace(' 00:00:00', '');
					td = $('<td class="fc-event-container" data-date="'+event_date+'"/>').append(seg.el);
