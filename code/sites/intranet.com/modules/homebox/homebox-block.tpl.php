 ...
 */
?>
<?php if ($block->delta == 'sakal_utility')print_r($block);?>
<div id="homebox-block-<?php print $block->key; ?>" class="<?php print $block->homebox_classes;  print ' '.$block->delta; ?> clearfix block block-<?php print $block->module ?>">
