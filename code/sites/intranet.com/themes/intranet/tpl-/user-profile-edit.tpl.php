		...
		<div class="workInfo">
			...
			<?php //print  $form['field__work_location']);
				if(isset($form['field_department'])) {
				  ...
				  '<span class="nonEditableField">' .$form['field_department']['und'][0]['value']['#value']. '</span>';
				}
				if(isset($form['field_project'])) {
				  print '<label>' .$form['field_project']['und'][0]['#title']. '</label>'. 
			 	  '<span class="nonEditableField">' .$form['field_project']['und'][0]['value']['#value']. '</span>';
				}
				...
				if(isset($form['field_employee_joining_date'])) {
				  ...
				  '<span class="nonEditableField">' .$form['field_employee_joining_date']['und'][0]['value']['#value']. '</span>';
				}
				if(isset($form['field_emp_status']) && !empty($form['field_emp_status']['und']['#value'][0])) {
				  print '<label>' .$form['field_emp_status']['und']['#title']. '</label>'. 
			 	  '<span class="nonEditableField">' .$form['field_emp_status']['und']['#value'][0]. '</span>';
				}			
			?>
		</div>
