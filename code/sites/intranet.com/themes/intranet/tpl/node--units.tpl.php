...
<div class="addressBg">
    ...
    <?php 
    if(isset($content['field_establishment_detail']['#object']->field_establishment_detail['und'][0]['value'])){
      print '<div class="field field-name-field-unit-address field-type-text-long field-label-hidden">';
      print $content['field_establishment_detail']['#object']->field_establishment_detail['und'][0]['value'];
      print '</div>';
    } else {
    print '<div class="empty-value">Not Available</div>';       
    }  ?>
